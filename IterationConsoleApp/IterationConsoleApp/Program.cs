...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Part 6 
        List<string> stringList1 = new List<string>() { "One", "Two", "Three", "Four" };
        List<string> stringList2 = new List<string>();

        foreach (string input in stringList2)
        {
            for (int i = 0; i < stringList1.Count -1; i++)
        ...
        Console.WriteLine(stringList2.Count);
        Console.ReadLine();
    }
}
